...
export default function KiosksPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <h1>Kiosk Devices</h1>
      <p className="mt-1 mb-8 text-muted">Register iPad devices for Spotlight capture at your counter.</p>
      ...
      {/* New kiosk URL */}
      {newKioskUrl && (
        <div className="mb-8 rounded-xl border border-green-600 bg-green-600/10 p-4">
      ...
      {kiosks.length > 0 && (
        <div>
          ...
          {kiosks.map((kiosk) => (
            <div key={kiosk.id} className="flex items-center justify-between border-b border-border py-3">
              <div>
